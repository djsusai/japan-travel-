/* The trip itself. Every figure here comes from the booking confirmations the
   traveller supplied — the Etihad flights, the Toyota rental, and the five
...
(function () {
  ...
  window.STAGES = [
    { id:"s1", start:"2026-09-26", end:"2026-09-27", kind:"flight", n:"✈", date:"26.9 – 27.9", title:"תל אביב → אבו דאבי", en:"TLV → AUH", short:"תל אביב",
      ...
      facts:[["חברה","ETIHAD · קוד ההזמנה במייל"],["לילה","לילה בטיסה / המתנה באבו דאבי"]] },

    { id:"s2", start:"2026-09-27", end:"2026-09-28", kind:"flight", n:"✈", date:"27.9 – 28.9", title:"אבו דאבי → אוסקה", en:"AUH → KIX", short:"אבו דאבי",
      ...
      facts:[["בנחיתה","Visit Japan Web · כרטיס ICOCA · מזומן ¥15,000–20,000 · eSIM"],["חברה","ETIHAD · קוד ההזמנה במייל"]] },

    { id:"s3", start:"2026-09-28", end:"2026-09-28", kind:"car", n:"1", date:"28.9, 12:30", title:"איסוף הרכב בקנסאי", en:"Toyota Rent a Car · KIX", short:"שדה קנסאי",
      ...
      facts:[["כתובת","<span class='en'>Aeroplaza 1F, 1 Senshukukonaka, Tajiri-cho, Sennan-gun, Osaka 549-0011</span>"],
             ...
             ["מספר הזמנה","מופיע באישור ההשכרה במייל"],
    ...
    { id:"s4", start:"2026-09-28", end:"2026-10-01", kind:"city", n:"2", date:"28.9 – 1.10", title:"אוסקה", en:"Osaka · 3 לילות", short:"אוסקה",
    ...
    { id:"s5", start:"2026-10-01", end:"2026-10-04", kind:"city", n:"3", date:"1.10 – 4.10", title:"קיוטו", en:"Kyoto · 3 לילות", short:"קיוטו",
    ...
    { id:"s6", start:"2026-10-04", end:"2026-10-04", kind:"stop", n:"4", date:"4.10", title:"מאגומה", en:"Magome-juku · עצירה", short:"מאגומה",
    ...
    { id:"s7", start:"2026-10-04", end:"2026-10-04", kind:"stop", n:"5", date:"4.10", title:"צומאגו", en:"Tsumago-juku · עצירה", short:"צומאגו",
      meta:["רכב","‎~4 ק״מ","‎~10 ד׳"],
    ...
    { id:"s8", start:"2026-10-04", end:"2026-10-05", kind:"city", n:"6", date:"4.10 – 5.10", title:"פוג׳י · אויאמה", en:"Fuji Speedway Hotel · לילה 1", short:"פוג׳י",
    ...
    { id:"s9", start:"2026-10-05", end:"2026-10-07", kind:"city", n:"7", date:"5.10 – 7.10", title:"האקונה", en:"Hakone · 2 לילות", short:"האקונה",
    ...
    { id:"s10", start:"2026-10-07", end:"2026-10-07", kind:"car", n:"8", date:"7.10, 12:00", title:"החזרת הרכב באודוארה", en:"Odawara Sta. Shinkansen Ext.", short:"אודוארה",
    ...
    { id:"s11", start:"2026-10-07", end:"2026-10-14", kind:"city", n:"9", date:"7.10 – 14.10", title:"טוקיו · שיבויה", en:"Tokyo · 7 לילות", short:"טוקיו",
    ...
    { id:"s12", start:"2026-10-14", end:"2026-10-15", kind:"flight", n:"✈", date:"14.10 – 15.10", title:"נאריטה → אבו דאבי", en:"NRT → AUH", short:"נאריטה",
      ...
      facts:[["שדה תעופה","<span class='en'>Narita Airport, Terminal 1</span>"],["חברה","ETIHAD · קוד ההזמנה במייל"],
             ["מפה", gmaps(35.7719,140.3929)]] },

    { id:"s13", start:"2026-10-15", end:"2026-10-15", kind:"flight", n:"✈", date:"15.10", title:"אבו דאבי → תל אביב", en:"AUH → TLV", short:"תל אביב",
      ...
      facts:[["חברה","ETIHAD · קוד ההזמנה במייל"]] },
  ];
